...
module.exports = new types_1.Command(new discord_js_1.SlashCommandBuilder().setName("다음").setDescription("다음 곡을 재생합니다."), async (interaction, bot) => {
    ...
    await interaction.editReply({
        embeds: [new discord_js_1.EmbedBuilder().setColor("#008000").setTitle(":fast_forward: 곡을 스킵했어요")],
    });
});
