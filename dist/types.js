            ...
            await this.textChannel.send({
                embeds: [
                    new discord_js_1.MessageEmbed()
                        ...
                        .setDescription(`[${this.songs[0].title}](${this.songs[0].url}) (${this.songs[0].duration > 59 ? Math.floor(this.songs[0].duration / 60) : "0"}:${String(this.songs[0].duration % 60).padStart(2, "0")})`)
